...
// @generated from file api/tv_private/v1/private.proto (package api.tv_private.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 * mw:string;
 *
 * @generated from message api.tv_private.v1.Location
 */
export class Location extends Message<Location> {
  ...
  /**
   * @generated from field: repeated api.tv_private.v1.Record data = 4;
   */
  data: Record[] = [];
  ...
  static readonly typeName = "api.tv_private.v1.Location";
...
/**
 * @generated from message api.tv_private.v1.Record
 */
export class Record extends Message<Record> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "api.tv_private.v1.Record";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
