...
export function ModelVodAccount_Column(props: EnhancedTableProps) {
    ...
    return (
        <TableHead>
            <TableRow>
                ...
                <StyledTableCell align="center">{t("distributor")}</StyledTableCell>
                <StyledTableCell align="center">{t("model")}</StyledTableCell>
                <StyledTableCell align="center">{t("package Name")}</StyledTableCell>
                <StyledTableCell align="center">{t("aliasName")}</StyledTableCell>
