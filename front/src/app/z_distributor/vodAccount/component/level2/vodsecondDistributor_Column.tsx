...
export function VodsecondDistributor_Column(props: EnhancedTableProps) {
    ...
    return (
        <TableHead>
            <TableRow>
                ...
                <StyledTableCell align="center">{t("id")}</StyledTableCell>
                ...
                <StyledTableCell align="center">{t("categoryName")}</StyledTableCell>
                <StyledTableCell align="center">{t("className")}</StyledTableCell>
                <StyledTableCell align="center">{t("createAt")}</StyledTableCell>
