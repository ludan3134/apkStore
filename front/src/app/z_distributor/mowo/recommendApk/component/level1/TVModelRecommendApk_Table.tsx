...
import {ModelRecommendApk_Column} from "./ModelRecommendApk_Column";
import {StyledTableCell, StyledTableRow,} from "../../../../../../const/tablestyle";
import {message} from "antd";
import {RecommendStoreproxy} from "../../store/level2/store";
import {ProvideTemplateStoreProxy} from "../../../../tv/deskImage/store/level1/store";
import {grpcQueryProvideTemplatelist} from "../../../../tv/deskImage/api/level1/grpcQueryProvideTemplatelist";
import {RecommendApk} from "../../../../../../api/ta/v1/tam_pb";
import {grpcDeleteProvideTemplate} from "../../../../tv/deskImage/api/level1/grpcDeleteProvideTemplate";

export default function TVModelRecommendApk_Table() {
    // 刷新页面
    ...
    const handleditProvideTemplate = async (row) => {
        let foundOption = childrenMenu.find(
            (option) => option.name === "编辑分销商所属APK推荐型号",
        );
        if (foundOption) {
