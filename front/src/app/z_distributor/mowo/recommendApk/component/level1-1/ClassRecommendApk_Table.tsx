...
import {ClassRecommendApk_Column} from "./ClassRecommendApk_Column";
import {StyledTableCell, StyledTableRow,} from "../../../../../../const/tablestyle";
import {message} from "antd";
import {grpcAllOption} from "../../../../../tsv/option/api/grpcAllOption";
import {RecommendStoreproxy, useproxy_RecommendUrl,} from "../../store/level2/store";

export default function ClassRecommendApk_Table() {
    // 刷新页面
    ...
    const handlfindsublevel = async (row) => {
        ...
        if (foundOption) {
            RecommendStoreproxy.RecommendFilter.classId = row.id;
