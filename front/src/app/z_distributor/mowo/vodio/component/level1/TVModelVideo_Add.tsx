...
import {
    initialProvideTemplateParams,
    useproxy_ProvideTemplatetableUrl,
} from "../../../../tv/deskImage/store/level1/store";
import {grpcAddProvideTemplate} from "../../../../tv/deskImage/api/level1/grpcAddProvideTemplate";

export const TVModelVideo_Add = () => {
    ...
    const onSubmit = async (data: ProvideTemplate) => {
        ...
        if (!Distributorvalue || !Modelvalue) {
            message.error("Por favor, selecione o distribuidor e o modelo.");
            setLoading(false);
            return;
        }
