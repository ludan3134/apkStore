...
import {ClassVideo_Column} from "./ClassVideo_Column";
import {StyledTableCell, StyledTableRow,} from "../../../../../../const/tablestyle";
import {message} from "antd";
import {useproxy_VideoUrl, VideoStoreproxy} from "../../store/level2/store";
import {grpcAllOption} from "../../../../../tsv/option/api/grpcAllOption";
import {RecommendStoreproxy} from "../../../../../tsv/recommend/store/store";

export default function ClassVideo_Table() {
    // 刷新页面
    ...
    const handlfindsublevel = async (row) => {
        ...
        if (foundOption) {
            VideoStoreproxy.VideoFilter.classId = row.id;
