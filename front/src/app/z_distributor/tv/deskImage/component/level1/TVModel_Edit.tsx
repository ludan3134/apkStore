...
import {useproxy_ProvideTemplateEdit, useproxy_ProvideTemplatetableUrl,} from "../../store/level1/store";
import {message} from "antd";
import {grpcUpdateProvideTemplate} from "../../api/level1/grpcUpdateProvideTemplate";
import {authProxy} from "../../../../../auth/store/store";
import CircularIndeterminate from "../../../../../../const/alert/circularIndeterminate";
import LocationBar from "../../../../../../const/locationbar";
import {useTranslation} from "react-i18next";

export const TVModel_Edit = () => {
    // 获取编辑变量
    ...
    return (
        ...
        >
            ...
            <Stack spacing={2}>
                ...
                <TextFieldElement name="descriptionAddPic" label={t("Note")}/>
            </Stack>
            <DialogActions>
