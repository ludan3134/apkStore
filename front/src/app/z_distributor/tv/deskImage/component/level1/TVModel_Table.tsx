...
import {AdvertisementPictureStoreProxy} from "../../store/level2/store";
import {grpcDeleteProvideTemplate} from "../../api/level1/grpcDeleteProvideTemplate";

export default function TVModel_Table() {
    // 刷新页面
    ...
    const handlfindsublevel = async (row) => {
        ...
        if (foundOption) {
            AdvertisementPictureStoreProxy.AdvertisementPictureFilter.distributorId =
                row.distributorId;
            AdvertisementPictureStoreProxy.AdvertisementPictureFilter.modelId =
                row.modelId;
                        ...
                        return (
                            ...
                            >
                                ...
                                <StyledTableCell style={{width: 25}} align="center">
                                    <span>{row.descriptionAddPic}</span>
                                </StyledTableCell>
