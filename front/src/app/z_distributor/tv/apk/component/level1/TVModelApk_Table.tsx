...
import {ModelApk_Column} from "./ModelApk_Column";
...
import {ApkStoreProxy} from "../../store/level2/store";
import {grpcDeleteProvideTemplate} from "../../../deskImage/api/level1/grpcDeleteProvideTemplate";

export default function TVModelApk_Table() {
    // 刷新页面
    ...
    const handlfindsublevel = async (row) => {
        ...
        if (foundOption) {
            ApkStoreProxy.ApkFilter.distributorId = row.distributorId;
            ApkStoreProxy.ApkFilter.modelId = row.modelId;
                            ...
                            <Stack spacing={2} direction={"row"}>
                                <IconButton aria-label="delete" size="large">
                                    ...
                                    <Typography
                                        ...
                                        marginTop={2}
                                    >
                                        {t("Currently on the Market APK interface")}
                                    </Typography>
                                </IconButton>
                            </Stack>
                        </StyledTableCell>
