...
import {grpcQueryAllMacAuthRecordList} from "../api/grpcQueryAllMacAuthRecordList";
import {MacAuthRecord_Column} from "./MacAuthRecord_Column";

export default function MacAuthRecord_Table() {
    // 刷新页面
    ...
    React.useEffect(() => {
        const fetchData = async () => {
            var res = await grpcQueryAllMacAuthRecordList(page, rowsPerPage, authProxy.token);
            setRows(res.macAuthList);
