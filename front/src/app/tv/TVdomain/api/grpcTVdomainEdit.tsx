...
import {UpdateServerRequest, UpdateServerResponse,} from "../../../../api/tv_as/v1/as_pb";
import {Server} from "../../../../api/tv_asm/v1/asm_pb";

export const grpcTVdomainEdit = async (
    Server: Server,
    token: string,
    ...
    try {
        const res = await TVAsvClient.updateServer(req, {headers: headers});
