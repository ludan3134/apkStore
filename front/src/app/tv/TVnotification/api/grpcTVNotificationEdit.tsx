...
import {UpdateNotificationRequest, UpdateNotificationResponse,} from "../../../../api/tv_fs/v1/fs_pb";
import {TVFsvClient} from "../../../../grpcClinet/grpcTVFsvClient";

export const grpcTVNotificationEdit = async (
    ...
    try {
        const res = await TVFsvClient.updateNotification(req, {headers: headers});
