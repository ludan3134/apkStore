...
import {DeleteAccountInfoListRequest, DeleteAccountInfoListResponse,} from "../../../../api/tv_as/v1/as_pb";
import {TVAsvClient} from "../../../../grpcClinet/grpcTVAsvClient";

export const grpcTVAccountDelete = async (
    accountIds: string[],
    token: string,
    ...
    try {
        const res = await TVAsvClient.deleteAccountInfoList(req, {
            headers: headers,
        });
