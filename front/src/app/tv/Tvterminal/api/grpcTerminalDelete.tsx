...
import {DeleteTerminalInfoListRequest, DeleteTerminalInfoListResponse,} from "../../../../api/tv_as/v1/as_pb";

export const grpcTVTerminalDelete = async (
    terminalIds: string[],
    token: string,
    ...
    try {
        const res = await TVAsvClient.deleteTerminalInfoList(req, {
            headers: headers,
        });
