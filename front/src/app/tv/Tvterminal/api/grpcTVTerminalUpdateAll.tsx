...
import {
    UpdateTerminalInfoListStatusRequest,
    UpdateTerminalInfoListStatusResponse,
} from "../../../../api/tv_as/v1/as_pb";
import {TVAsvClient} from "../../../../grpcClinet/grpcTVAsvClient";

export const grpcTVTerminalUpdateAll = async (
    ...
    try {
        const res = await TVAsvClient.updateTerminalInfoListStatus(req, {
            headers: headers,
        });
