...
import {initialTVTerminalBulkImportParams, useproxy_TVTerminaltableUrl,} from "../store/store";
import {TVTerminalBulkImport} from "../store/model";
...
export const TVterminal_BulkInsert = () => {
    // 获取accounttable地址信息
    ...
    const formContext = useForm<TVTerminalBulkImport>({
        // 初始化表单数据
        defaultValues: initialTVTerminalBulkImportParams,
    });
                ...
                <Stack style={{width: "558px", height: "296px"}}>
                    <ImageListItem>
                        <img
                            ...
                            src={`http://upd.rja3.xyz/images/Apps/20240904153459.png?w=50&h=50&fit=crop&auto=format`}
