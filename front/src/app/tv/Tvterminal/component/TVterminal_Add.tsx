...
import {initialTVTerminalParams, useproxy_TVTerminaltableUrl,} from "../store/store";
...
export const TVterminal_Add = () => {
    ...
    const formContext = useForm<TerminalInfo>({
        // 初始化表单数据
        defaultValues: initialTVTerminalParams,
    });
