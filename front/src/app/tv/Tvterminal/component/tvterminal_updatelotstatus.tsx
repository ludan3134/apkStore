...
import {grpcTVTerminalUpdateAll} from "../api/grpcTVTerminalUpdateAll";

export default function Tvterminal_updatelotstatus(rows) {
    ...
    const handleOk = async () => {
        ...
        const res = await grpcTVTerminalUpdateAll(
            Distributorvalue,
            lotvalue,
            IsActive,
            IsService,
