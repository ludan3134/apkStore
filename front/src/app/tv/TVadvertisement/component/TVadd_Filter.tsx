...
import {initialTVAddfilterParams, TVAddStoreProxy} from "../store/store";
...
const TVAdd_Filter = () => {
    ...
    const formContext = useForm<Advertisement>({
        defaultValues: initialTVAddfilterParams,
    });
    // 分销商值
    ...
    const handleSubFormSubmit = (data: Advertisement) => {
        ...
        TVAddStoreProxy.TVAddFilter = data;
        // apkProxy.isRowChange = true
    };
    const handleResetForm = () => {
        formContext.reset(); // 重置表单值
        setDistributorvalue(null);
        TVAddStoreProxy.TVAddFilter = {} as Advertisement;
    };
