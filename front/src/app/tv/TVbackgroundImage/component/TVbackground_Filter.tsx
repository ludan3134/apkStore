...
import {initialTVBackgroundfilterParams, TVBackgroundStoreProxy,} from "../store/store";
...
export const TVBackground_Filter = () => {
    ...
    const handleSubFormSubmit = (data: HomeBackgroundImage) => {
        ...
        TVBackgroundStoreProxy.TVBackgroundFilter = data;
        // apkProxy.isRowChange = true
    };
    const handleResetForm = () => {
        formContext.reset(); // 重置表单值
        setDistributorvalue(null);
        TVBackgroundStoreProxy.TVBackgroundFilter = {} as HomeBackgroundImage;
    };
