...
import {TVDesktopImageStoreProxy} from "../store/store";

export const TVdeskImage_Filter = () => {
    ...
    const handleSubFormSubmit = (data: AdvertisementPicture) => {
        ...
        TVDesktopImageStoreProxy.TVDesktopImageFilter = data;
        // apkProxy.isRowChange = true
    };
    const handleResetForm = () => {
        formContext.reset(); // 重置表单值
        setDistributorvalue(null);
        TVDesktopImageStoreProxy.TVDesktopImageFilter = {};
    };
