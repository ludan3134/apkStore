...
import {UpdateLotRequest, UpdateLotResponse,} from "../../../../api/as/v1/as_pb";
import {Lot} from "../../../../api/asm/v1/asm_pb";
import {TVAsvClient} from "../../../../grpcClinet/grpcTVAsvClient";

export const grpcLotEdit = async (
    lot: Lot,
    token: string,
): Promise<UpdateLotResponse> => {
    const req = new UpdateLotRequest({
        transactionId: 6758n,
        sessionId: 7769n,
        lot: lot,
    });
    ...
    try {
        const res = await TVAsvClient.updateLot(req, {headers: headers});
