...
export function Role_Column(props: EnhancedTableProps) {
    ...
    return (
        <TableHead>
            <TableRow>
                ...
                <StyledTableCell align="center">是否为分销商</StyledTableCell>
                <StyledTableCell align="center">授权</StyledTableCell>
