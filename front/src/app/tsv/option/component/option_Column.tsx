...
export function Option_Column(props: EnhancedTableProps) {
    ...
    return (
        <TableHead>
            <TableRow>
                ...
                <StyledTableCell align="center">顶部标题</StyledTableCell>
                <StyledTableCell align="center">中部标题</StyledTableCell>
                <StyledTableCell align="center">底部标题</StyledTableCell>
