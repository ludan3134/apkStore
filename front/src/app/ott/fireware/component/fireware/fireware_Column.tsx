...
export function Fireware_Column(props: EnhancedTableProps) {
    ...
    return (
        <TableHead>
            <TableRow>
                ...
                <StyledTableCell align="center">查看固件版本</StyledTableCell>
                <StyledTableCell align="center">编辑固件</StyledTableCell>
                <StyledTableCell align="center">删除固件</StyledTableCell>
            </TableRow>
        </TableHead>
    );
}
