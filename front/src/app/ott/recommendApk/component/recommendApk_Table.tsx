...
import {RecommendApk_Column} from "./recommendApk_Column";
...
import Autodistributor2modelForOTT
    from "../../../../const/distributortomodel/component/ott/component/autoditributor2modelForOtt";
import RecommendApk_Filter from "./recommendApk_Filter";

export default function RecommendApk_Table() {
    // 刷新页面
    ...
    const handldeleteRecommend = async (row: RecommendApk) => {
        ...
        if (foundOption) {
            ...
            row.deleted = true;
            setDeleteRow(row);
            setAction(ActionStore.DeleteRecommendApk);
            return true; // 添加返回 true 停止循环
        } else {
            message.error("暂无权限");
        }
                        ...
                        return (
                            ...
                            >
                                ...
                                <StyledTableCell style={{width: 30}} align="center">
                                    <Autodistributor2modelForOTT id={row.id}/>
                                </StyledTableCell>
                                <StyledTableCell style={{width: 30}} align="center">
                                    <Button
                                        variant="contained"
