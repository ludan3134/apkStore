...
import {useproxy_TerminalEdit, useproxy_TerminaltableUrl,} from "../store/store";
...
export const Terminal_Edit = () => {
    // 获取编辑变量
    var terminal = useproxy_TerminalEdit();
    // 获取terminaltable地址信息
    ...
    return (
        ...
        >
            ...
            <Stack spacing={2}>
                <LocationBar location={"编辑terminal"}/>
                ...
                {/*<Modelinput Distributorvalue={Distributorvalue} setModelvalue={setModelvalue}/>*/}
                <SelectElement
                    size={"medium"}
                    label="设置激活状态"
                    name="setActive"
