...
import {InsertNotificationRequest, InsertNotificationResponse,} from "../../../../api/fs/v1/fs_pb";
import {FsvClient} from "../../../../grpcClinet/grpcFsvClient";
import {Notification} from "../../../../api/fs/v1/fm_pb";

export const grpcNotificationInsert = async (
    ...
    try {
        const res = await FsvClient.insertNotification(req, {headers: headers});
