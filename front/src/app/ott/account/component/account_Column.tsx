...
export function Account_Column(props: EnhancedTableProps) {
    ...
    return (
        <TableHead>
            <TableRow>
                ...
                <StyledTableCell align="center">创建XC账号</StyledTableCell>
            </TableRow>
        </TableHead>
    );
}
