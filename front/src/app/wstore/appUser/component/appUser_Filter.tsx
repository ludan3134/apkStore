...
import {AppUserStoreProxy, initialAppUserfilterParams} from "../store/store";
import {AppUser} from "../../../../api/ws/v1/wm_pb";

export const AppUser_Filter = () => {
    ...
    // 分销商值
    const handleSubFormSubmit = (data: AppUser) => {
        ...
        AppUserStoreProxy.AppUserFilter = data;
