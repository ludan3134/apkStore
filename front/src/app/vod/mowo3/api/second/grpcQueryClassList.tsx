...
import {QueryClassListRequest, QueryClassListResponse,} from "../../../../../api/ks/v1/ks_pb";
import {KsvClient} from "../../../../../grpcClinet/grpcKsvClient";
import {ClassData} from "../../../../../api/ks/v1/km_pb";

export const grpcQueryClassList = async (
    page: number,
    rowsPerPage: number,
    token: string,
    firstID: number,
    ...
    const req = new QueryClassListRequest({
        ...
        classFilter: new ClassData({mowoClassId: firstID}),
    });
    console.info("grpcTerminalList-req", req);
    var headers = new Headers();
    headers.set("token", token);
    try {
        const res = await KsvClient.queryClassList(req, {headers: headers});
