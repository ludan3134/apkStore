...
export function Vodfirst_Column(props: EnhancedTableProps) {
    ...
    return (
        <TableHead>
            <TableRow>
                ...
                <StyledTableCell align="center">权限访问</StyledTableCell>
                <StyledTableCell align="center">数量</StyledTableCell>
                <StyledTableCell align="center">查看二级分类</StyledTableCell>
                <StyledTableCell align="center">查看子类别</StyledTableCell>
                <StyledTableCell align="center">查看轮播图</StyledTableCell>
