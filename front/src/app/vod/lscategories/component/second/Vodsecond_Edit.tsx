...
import {grpcVodSecondEdit} from "../../api/second/grpcVodSecondEdit";
import {useproxy_VodEdit} from "../../store/second/store";
import {Vod} from "../../../../../api/ks/v1/km_pb";

export const Vodsecond_Edit = () => {
    // 获取编辑变量
    var Vod = useproxy_VodEdit();
    ...
    const formContext = useForm<Vod>({
        ...
        defaultValues: {
            ...
            episodeRunTime: Vod.episodeRunTime,
    ...
    const onSubmit = async (data: Vod) => {
        ...
        try {
            // 执行数据更新操作
            var response = await grpcVodSecondEdit(data, authProxy.token);
